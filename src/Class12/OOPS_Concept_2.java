...
import Class11.Inheritance.BMCLass;
import Class11.Inheritance.CClass;
import Class11.Polymorphism.UserMethods;
import Class12.ConstructorPkg.MyConstructor;
...
public class OOPS_Concept_2 {
    public static void main(String[] args) {
        ...
        BMCLass bb = new BMCLass();
        bb.printParentName();

        bb.sayHelloToUser("Happy"); // Hello Happy

        bb.sayHelloToUser("Happy"); // Hey Happy, whats up!

        // override, but want to run parent method
